...
"""
    ...
    def homeContent(self, filter):
        ...
        # 這裡定義篩選器內容
        filters = {
            "100": [{"k": "year", "name": "年份", "value": [{"n": "全部", "v": ""}, {"n": "2024", "v": "2024"}, {"n": "2023", "v": "2023"}, {"n": "2022", "v": "2022"}]},
                   {"k": "region", "name": "地区", "value": [{"n": "全部", "v": ""}, {"n": "中国", "v": "中国"}, {"n": "香港", "v": "香港"}, {"n": "台湾", "v": "台湾"}, {"n": "美国", "v": "美国"}]},
                   {"k": "sort_field", "name": "排序", "value": [{"n": "最新", "v": "create_time"}, {"n": "最热", "v": "v_views"}]}],
            "101": [{"k": "year", "name": "年份", "value": [{"n": "全部", "v": ""}, {"n": "2024", "v": "2024"}, {"n": "2023", "v": "2023"}]}]
            # 你可以依照網頁上的篩選項目繼續添加
        }
