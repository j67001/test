...
def get_filters(self):
        ...
        return {
            '1': [ # 电影
                {'key': 'type', 'name': '类型', 'value': [{'n': '全部', 'v': ''}, {'n': '喜剧', 'v': '/type/22'}, {'n': '动作', 'v': '/type/23'}, {'n': '科幻', 'v': '/type/30'}, {'n': '恐怖', 'v': '/type/36'}]},
                {'key': 'year', 'name': '年份', 'value': years},
                {'key': 'by', 'name': '排序', 'value': sort_opts}
            ],
            '2': [ # 电视剧
                {'key': 'type', 'name': '类型', 'value': [{'n': '全部', 'v': ''}, {'n': '国产剧', 'v': '/type/14'}, {'n': '欧美剧', 'v': '/type/15'}, {'n': '港台剧', 'v': '/type/16'}, {'n': '日韩剧', 'v': '/type/62'}]},
                {'key': 'year', 'name': '年份', 'value': years},
                {'key': 'area', 'name': '地区', 'value': [{'n': '全部', 'v': ''}, {'n': '大陆', 'v': '/area/中国大陆'}, {'n': '香港', 'v': '/area/中国香港'}, {'n': '台湾', 'v': '/area/中国台湾'}, {'n': '美国', 'v': '/area/美国'}, {'n': '韩国', 'v': '/area/韩国'}]},
                {'key': 'by', 'name': '排序', 'value': sort_opts}
            ],
            '3': [ # 综艺
                {'key': 'type', 'name': '类型', 'value': [{'n': '全部', 'v': ''}, {'n': '国产综艺', 'v': '/type/69'}, {'n': '港台综艺', 'v': '/type/70'}, {'n': '日韩综艺', 'v': '/type/72'}]},
                {'key': 'year', 'name': '时间', 'value': years},
                {'key': 'by', 'name': '排序', 'value': sort_opts}
            ],
            '4': [ # 动漫
                {'key': 'type', 'name': '类型', 'value': [{'n': '全部', 'v': ''}, {'n': '国产动漫', 'v': '/type/75'}, {'n': '日韩动漫', 'v': '/type/76'}, {'n': '欧美动漫', 'v': '/type/77'}]},
                {'key': 'year', 'name': '时间', 'value': years},
                {'key': 'by', 'name': '排序', 'value': sort_opts}
            ]
        }
